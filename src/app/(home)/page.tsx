import DocumentationButton from "@/app/components/Home/DocumentationButton";
import GitHubSignIn from "@/app/components/Home/GitHubSignIn";
import ParticlesBackground from "@/app/components/Home/ParticlesBackground";
import ToTopArrow from "@/app/components/Home/ToTopArrow";
import ScrollChevron from "@/app/components/Home/ScrollChevron";
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8">
        ...
        <h3 className="text-lg sm:text-xl md:text-2xl font-merriweather text-center pt-2">
          Fixing how developers handle forms by simplifying and streamlining the
          process.
        </h3>
      ...
      <section className="relative z-20">
        {/* Wave SVG divider */}
        <svg
          className="w-full h-auto block z-[100]"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1440 320"
          preserveAspectRatio="none"
          style={{ marginBottom: "-1px" }} // Ensures no gap between SVG and section
        >
          <path
            fill="var(--foreground)"
            fillOpacity="1"
        ...
        <div className="bg-[var(--foreground)] text-background">
          {/* API Feature */}
          <div
